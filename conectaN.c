    ...
    if(mov->jugador == 1) {
        ...
        while(b == 1) {
            ...
            while (b == 0 && i <= juego->turno) {
                if ((*(array + i))->columna == columna && (*(array + i))->renglon == renglon  && mov->jugador == 1)
                    b = 1;
                else
                    i++;
            }
        ...
        while(b == 1) {
            ...
            renglon++;
            while (b == 0 && i < juego->turno) {
                if ((*(array2 + i))->columna == columna && (*(array2 + i))->renglon == renglon && mov->jugador == 2)
                    b = 1;
                else
                    i++;
            }
